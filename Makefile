...
.PHONY: network postgres postgres_standalone createdb dropdb migrateup migrateup1 migratedown migratedown1 new_migration sqlc test server mock proto evans redis_standalone